            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="img/image1.png" alt="" style="object-fit: cover; height: 40px;">
                    </div>
                </div>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                       <video  autoplay loop muted style="height: 500px; margin-top: 10px ;width: 550px;">
                            <source src="img/vid1.mp4" type="video/mp4"> <!-- Vidéo en format MP4 -->
...
<div class="gtco-cover gtco-cover-sm" style="background-image: url(img/section.png)"  data-stellar-background-ratio="0.5" data-aos="fade-up" class="feature-center animate__animated animate__fadeIn">
