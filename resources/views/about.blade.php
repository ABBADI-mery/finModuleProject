            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-5 pb-lg-5">
                    <div class="about-text bg-white p-3 p-lg-2 my-lg-5">
                        ...
                        <h1 class="mb-3">Explorez le Monde avec VoyageFM : Votre Partenaire de Confiance pour des Voyages Inoubliables</h1>
                        <p>VoyageFM est une agence de voyage dédiée à transformer vos rêves d’évasion en réalité. Que vous cherchiez à explorer des destinations exotiques, à découvrir des merveilles culturelles ou à profiter 
                            d’un séjour relaxant, nous vous proposons des forfaits sur mesure adaptés à votre budget. Grâce à notre expertise et notre passion pour les voyages, nous garantissons des expériences mémorables et sans souci. 
                            Chez VoyageFM, votre satisfaction est notre priorité, et nous nous engageons à vous offrir un service de qualité pour chaque étape de votre aventure. Voyagez avec nous et découvrez le monde autrement.
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-1">Profitez des meilleures offres et des prix adaptés à tous les budgets pour vos voyages de rêve.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-1">VoyageFM s'engage à vous offrir des prestations sur mesure et un service client irréprochable.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-1">Explorez le monde sans limite grâce à notre réseau étendu et nos destinations variées.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="faq-container">
        ...
        <div class="question" onclick="toggleAnswer(1)">
            ...
            <div class="answer" id="answer-1">
                <p>VoyageFM offre une vaste gamme d'expériences de voyage adaptées à tous les types de voyageurs. Que vous rêviez d’un séjour tout compris sur des plages paradisiaques, 
                    d’un circuit culturel pour découvrir l’histoire et les traditions d’un pays, d’une escapade de luxe dans des destinations prestigieuses, ou d’un voyage d’affaires 
                    organisé dans les moindres détails, nous sommes là pour concrétiser vos envies. Nous proposons également des aventures personnalisées, conçues sur mesure pour
                     répondre à vos attentes spécifiques, qu'il s'agisse de voyages en famille, entre amis ou en solo. Chez VoyageFM, notre priorité est de vous offrir des souvenirs
        ...
        <div class="question" onclick="toggleAnswer(5)">
            ...
            <div class="answer" id="answer-5">
                <p>Chez VoyageFM, nous acceptons plusieurs modes de paiement pour simplifier vos réservations. Vous pouvez régler par carte de crédit (Visa, MasterCard, American Express), via PayPal pour des transactions rapides et sécurisées, ou par virement bancaire.
                    Toutes nos méthodes de paiement sont protégées par des systèmes de sécurité avancés pour garantir la confidentialité de vos informations. De plus, nous proposons des options flexibles, comme le paiement en plusieurs fois, afin de rendre vos voyages
                     encore plus accessibles. Notre équipe est à votre disposition pour répondre à toutes vos questions concernant le paiement. Avec VoyageFM, vous réservez en toute sérénité !</p>
            </div>
        </div>
        <div class="question" onclick="toggleAnswer(6)">
            ...
            <div class="answer" id="answer-6">
                <p>Dans la plupart des cas, il est possible de modifier les dates de votre voyage. Cependant, cela dépend des politiques de nos partenaires et des disponibilités. Contactez-nous dès que possible pour effectuer une modification.</p>
            </div>
        </div>
    </div>
    <br><br>
