...
<head>
    ...
    <style>
        ...
        .formass:hover {
            background-color: rgba(162, 247, 3, 0.2);
        }
    </style>
</head>
...
<body>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Explorez le monde avec nos circuits soigneusement conçus pour une expérience inoubliable !</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <p>Réservez facilement votre hôtel avec notre service, en comparant prix et avis pour un séjour serein.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item rounded pt-3">
                        <div class="p-4">
                            ...
                            <h5>Planification</h5>
                            <p>Organisez facilement vos voyages avec notre service de planification et d'itinéraires personnalisé.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Couvrez vos frais en cas d'annulation imprévue pour des raisons valides.</p>
                        <button class="btn btn-primary details-btn" data-bs-toggle="modal" data-bs-target="#detailsModal" data-title="Assurance Annulation" data-content="Cette option rembourse vos frais d'annulation pour des raisons imprévues comme une maladie ou un imprévu familial.">
                            En savoir plus
                        </button>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="card-text">Bénéficiez d'une prise en charge médicale complète lors de vos déplacements.</p>
                        <button class="btn btn-primary details-btn" data-bs-toggle="modal" data-bs-target="#detailsModal" data-title="Assurance Médicale" data-content="Cette couverture prend en charge vos frais médicaux d'urgence à l'étranger, y compris les hospitalisations.">
                            En savoir plus
                        </button>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <button class="btn btn-primary details-btn" data-bs-toggle="modal" data-bs-target="#detailsModal" data-title="Assurance Bagages" data-content="Cette option vous indemnise en cas de perte, vol ou dommages à vos bagages pendant votre voyage.">
                            En savoir plus
                        </button>
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
            @auth
                @if (auth()->user()->reservations->isEmpty())
                    <div class="text-center">
                        <p class="mb-4">Vous n'avez aucune réservation. <a href="{{ route('booking') }}" class="text-primary">Créez une réservation</a> pour souscrire à une assurance.</p>
                    </div>
                @else
                    @if (session('success'))
                    ...
                    <form method="POST" action="{{ route('assurance.store') }}">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="duree" name="duree" readonly required>
    ...
    <div id="rooms">
        <div class="container">
            <div class="section-header">
                ...
                <br>
                <center>
                    <h6>Choisissez parmi une sélection d’hôtels adaptés à tous les styles de voyage et profitez d’un séjour inoubliable !</h6>
                </center>
                <br>
                <br>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                ...
                                <p>Proposez des logements avec cuisine équipée et espace de vie, parfaits pour les familles ou les longs séjours. Une option pratique pour les clients souhaitant plus d’autonomie.</p>
                                <ul class="room-icon">
                                    <i class="fas fa-shield-alt fa-2x mx-3"></i>
                                    <i class="fas fa-wind fa-2x mx-3"></i>
                                    <i class="fas fa-bath fa-2x mx-3"></i>
                                    <i class="fas fa-shower fa-2x mx-3"></i>
                                    <i class="fas fa-hanger fa-2x mx-3"></i>
                                    <i class="fas fa-tv fa-2x mx-3"></i>
                                    <i class="fas fa-wifi fa-2x mx-3"></i>
                                    <i class="fas fa-phone fa-2x mx-3"></i>
                                    <i class="fas fa-wine-bottle fa-2x mx-3"></i>
                                    <i class="fas fa-kitchen-set fa-2x mx-3"></i>
                                </ul>
                                <div class="room-link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                ...
                                <p>Offrez à vos clients une expérience exceptionnelle avec des hôtels haut de gamme, équipés de spas, restaurants étoilés, et services personnalisés. Idéal pour des voyages de prestige ou des lunes de miel.</p>
                                <ul class="room-icon">
                                    <i class="fas fa-shield-alt fa-2x mx-3"></i>
                                    <i class="fas fa-wind fa-2x mx-3"></i>
                                    <i class="fas fa-bath fa-2x mx-3"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                ...
                                <p>Des établissements uniques et design, souvent thématiques, qui séduisent les voyageurs en quête d’originalité et d’expériences personnalisées.</p>
                                <ul class="room-icon">
                                    <i class="fas fa-shield-alt fa-2x mx-3"></i>
                                    <i class="fas fa-wind fa-2x mx-3"></i>
                                    <i class="fas fa-bath fa-2x mx-3"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                ...
                                <p>Situés en bord de mer, ces hôtels sont parfaits pour les vacances détente. Ils offrent des activités nautiques et des paysages paradisiaques pour un séjour mémorable.</p>
                                <ul class="room-icon">
                                    <i class="fas fa-shield-alt fa-2x mx-3"></i>
                                    <i class="fas fa-wind fa-2x mx-3"></i>
                                    <i class="fas fa-bath fa-2x mx-3"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="room-des">
                                ...
                                <p>Une solution pratique et abordable pour les clients avec un budget limité ou pour les séjours d’affaires rapides, offrant des services de base mais efficaces.</p>
                                <ul class="room-icon">
                                    <i class="fas fa-shield-alt fa-2x mx-3"></i>
                                    <i class="fas fa-wind fa-2x mx-3"></i>
                                    <i class="fas fa-bath fa-2x mx-3"></i>
    ...
    <script>
        ...
        // Update destination and duree fields based on reservation selection
        ...
        // Trigger change event on page load to populate fields if a reservation is pre-selected
